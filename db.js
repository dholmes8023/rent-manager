...
const requiresSsl =
  config.DATABASE_URL.includes('render.com') || config.DATABASE_URL.includes('sslmode=require');
...
export async function migrate() {
  ...
  // Force update unit prices for all existing tariffs to the configured units.
